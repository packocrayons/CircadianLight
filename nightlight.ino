...
unsigned long secondsOfDay = 24000;
...
void loop() {
  ...
  if (((hoursOfDay >= 6 && minutesOfDay > 30) || hoursOfDay > 7) && hoursOfDay < 20) { //it's the morning, we should be incrementing
    if (ledBrightness < 255) ledBrightness++;
